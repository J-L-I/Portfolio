        ...
        <ol className="flex flex-col md-flex-row border-blue-300">
            <li className="mb-9 ml-3">
                ...
                <p className="flex flex-wrap gap-4 flex-row items-center justify-center text-sm md:text-sm">
                    <span className="inline-block px-2 py-2 font-bold rounded-md text-white text-2xl">
                        {job.year}
                    </span>
                    <span className="text-2xl font-bold text-white">
                        {job.title}
                    </span>
                    <span className="my-1 text-md text-2xl font-semibold leading-non text-white">
                        {job.description}
                    </span>
                </p>
            </li>
